...
from .views.coordinator import coordinator_progress_view, coordinator_requested_project, coordinator_edit_project, \
    ...
    coordinator_enroll_project, coordinator_report, coordinator_fe_report, coordinator_se_report, \
    coordinator_te_report, coordinator_be_report
...
urlpatterns = [
    ...
    path('coordinator_enroll_project/88468465149461<int:requested_project_id>9849684816641', coordinator_enroll_project, name='coordinator_enroll_project'),
    ...
    path('project_creator_add_task/749849849849841<int:id>894989848484', project_creator_add_task, name='project_creator_add_task'),
    ...
    path('coordinator_report/6989855255484<int:department_id><int:college_id>985623147856', coordinator_report, name='coordinator_report'),
    path('coordinator_fe_report/6989855255484/<int:department_id>/<int:college_id>/985623147856', coordinator_fe_report, name='coordinator_fe_report'),
    path('coordinator_se_report/6989855255484/<int:department_id>/<int:college_id>/985623147856', coordinator_se_report, name='coordinator_se_report'),
    path('coordinator_te_report/6989855255484/<int:department_id>/<int:college_id>/985623147856', coordinator_te_report, name='coordinator_te_report'),
    path('coordinator_be_report/6989855255484/<int:department_id>/<int:college_id>/985623147856', coordinator_be_report, name='coordinator_be_report'),
    ...
    path('348664613147686<int:project_id>786498490567823647467849/update_enroll_view', update_enroll_view, name='update_enroll_view'),
